        ...
        >
          ...
          <li>
            <button
              ...
              className={`w-full flex items-center py-3 rounded-xl transition-all duration-200 ${showSidebar ? 'justify-between px-4' : 'justify-center px-0'} ${
                activeTab === 'Hotels' ? 'bg-blue-600 text-white shadow-md shadow-blue-600/20 font-semibold' : 'hover:bg-white/5 hover:text-white font-medium'
              }`}
            >
              <div className={`flex items-center ${showSidebar ? 'gap-3.5' : ''}`}>
      ...
      <span className="text-[14px] whitespace-nowrap tracking-wide">Platform Console</span>
          ...
          <li>
            ...
            {showSidebar && openDropdown === 'Integrations' && (
              <ul className="mt-1 space-y-1 mb-2">
                <li><Link to="/LeadSources" onClick={() => handleLinkClick('Integrations')} className="flex items-center gap-3 px-4 py-2.5 pl-11 text-[13.5px] font-medium text-slate-400 hover:text-white hover:bg-white/5 rounded-lg whitespace-nowrap transition-colors"><Circle size={6} className="fill-current text-emerald-400/50" /><span>Lead Sources</span></Link></li>
                <li><Link to="/WhatsAppConfiguration" onClick={() => handleLinkClick('Integrations')} className="flex items-center gap-3 px-4 py-2.5 pl-11 text-[13.5px] font-medium text-slate-400 hover:text-white hover:bg-white/5 rounded-lg whitespace-nowrap transition-colors"><Circle size={6} className="fill-current text-emerald-400/50" /><span>WhatsApp</span></Link></li>
                <li><Link to="/EmailConfiguration" onClick={() => handleLinkClick('Integrations')} className="flex items-center gap-3 px-4 py-2.5 pl-11 text-[13.5px] font-medium text-slate-400 hover:text-white hover:bg-white/5 rounded-lg whitespace-nowrap transition-colors"><Circle size={6} className="fill-current text-emerald-400/50" /><span>Email</span></Link></li>
              </ul>
            )}
          </li>
          )}
